...
/*保存文件至文件目录中*/
const saveFileToContent = (fileId, fileName, totalSize, rootPath, directoryId, directory, fileType) => post('/fileContent/saveFileToContent', fileId, fileName, totalSize, rootPath, directoryId, directory, fileType)
/*获取文件目录*/
